...
export function UploadEventImage({ setUserEvent }: { setUserEvent: Dispatch<SetStateAction<UserEvent>> }) {
  ...
  return (
    <div className="d-flex flex-column gap-2">
      ...
      <img
        ...
        src={eventImageUrl || "https://archive.org/download/placeholder-image/placeholder-image.jpg"}
        width="350"
        height="250"
        alt="Event"
        style={{ objectFit: "cover", cursor: "pointer", boxShadow: "0 0 5px 0 #ccc"}}
